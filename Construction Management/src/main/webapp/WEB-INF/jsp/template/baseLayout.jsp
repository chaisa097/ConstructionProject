...
<body>
   ...
   <!-- end scripts -->
	...
	<c:if test="${not empty nameDomainSystem}">
    	<input type="hidden" id="nameDomainSystem" value="${nameDomainSystem}">
	</c:if>
	<c:if test="${empty nameDomainSystem}">
    	<input type="hidden" id="nameDomainSystem" value="">
	</c:if>
...
<script type="text/javascript">
	...
	var domainSystem = 'http://'+ipDomainSystem+document.getElementById("nameDomainSystem").value;
</script>
</body>
</html>