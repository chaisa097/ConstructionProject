  ...
  <div class="content-wrapper" style="margin-top:-89px;" >
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Manage Province</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-default" name="addEditData">
        <div class="box-header with-border">
          <h3 class="box-title"> Province Form</h3>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>ProvinceCode</label>
                  ...
                  <input type="text" id="provinceCode" class="form-control" placeholder="ProvinceCode" name="provinceCode" pattern="[A-Za-z]{3}" required="" >
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>ProvinceName</label>         
                  <input type="text" id="provinceName" class="form-control" placeholder="ProvinceName" name="provinceName" required="" >
        ...
        <div class="box-footer">
          <button    onclick="save()" data-toggle="modal" class="btn btn-info pull-right">Save</button>
        </div>
      </div>
      </form>
      <!-- /.box -->
           ...
           <div class="box">
            ...
            <div class="box-body">
              <table  class="table">
                ...
                <tr class="filters">
               <th></th>
		       <th><input  type="text" class="form-control" placeholder="Province Code" disabled></th>
               <th><input  type="text" class="form-control" placeholder="Province Name" disabled></th>
                </tr>
                </thead>
               <tbody>
		       </tbody>
