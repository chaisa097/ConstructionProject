        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <label>TypeCode</label>
						<input type="text" id="typeCode" class="form-control" placeholder="TypeCode" name="typeCode" >
            ...
            <div class="col-md-6">
              <div class="form-group">
               <label>TypeName</label>
		   <input type="text" id="typeName" class="form-control" placeholder="TypeName" name="typeName" >
           ...
           <div class="box">
            ...
            <div class="box-body">
              <table  class="table">
               ...
               <th><input  type="text" class="form-control" placeholder="Type Name" disabled></th>
                </tr>
                </thead>
               <tbody>
		       </tbody>
