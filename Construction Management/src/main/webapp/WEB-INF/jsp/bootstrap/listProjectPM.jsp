	...
	<section class="content">
		...
		<div class="panel panel-info filterable">
			<div class="box">
				...
				<div class="col-xs-2">
					<h3 style="margin-top:3px;margin-left: -8px; " class="box-title">Project List</h3>
					</div>
				<div class="col-xs-6">
					
			   	<div style="margin-left:3px; " class="row" id="roleHeader">
							
								<label style="color:black;">Province</label> <select
									class="selectpicker show-tick show-menu-arrow" name="provinceList"
									data-live-search="true" data-size="5" data-header="Select Province"></select>
					...
					<table class="table">
						<thead>
							<tr class="filters">
								...
								<th><input type="text" class="form-control"
									placeholder="Completed" disabled></th>
							</tr>
						</thead>
						<tbody>
						</tbody>
