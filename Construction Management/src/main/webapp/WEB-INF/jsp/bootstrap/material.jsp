	...
	<section class="content">
		...
		<div class="box box-default" name="addEditData">
			<div class="box-header with-border">
				<h3 class="box-title">Material Form</h3>
			...
			<div class="box-body">
				<div class="row">
					<div class="col-md-4">
						<label>MaterialCode</label> <input id="matCode" type="text"
							class="form-control" placeholder="Material Code"
							name="materialCode" > <label>Type</label> <select
							class="form-control select2" id="type" name="typeList"
					...
					<div class="col-md-4">
						...
						<label>MaterialName</label> <input id="matName" type="text"
							class="form-control" placeholder="Material Name"
							name="materialName"> <label>Unit</label> <select
							class="form-control select2" id="unit" name="unitList"
							data-live-search="true" data-size="5" data-header="Select Unit"></select>
					</div>
					<div class="col-md-4">
						<label>Description</label>
						<textarea id="descript" class="form-control"
