			...
			<div class="row">
				...
				<div class="panel panel-info filterable">
					<div class="panel-heading">
						<h3 class="panel-title">List Employee</h3>
 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper" style="margin-top:-89px;" >
    ...
    <section class="content">
          ...
          <button style="margin-top:-10px;margin-bottom: -10px;margin-left: -25px;" class="btn btn-app"  onclick="createEmployee()" > <i class="fa  fa-plus"></i>New Employee</button>
