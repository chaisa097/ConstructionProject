        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>DepartmentCode</label>
                 	...
                 	<input type="text" id="departmentCode" class="form-control" placeholder="DepartmentCode" name="departmentCode" >
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label>DepartmentName</label>         
                <input type="text" id="departmentName" class="form-control" placeholder="DepartmentName" name="departmentName" >
