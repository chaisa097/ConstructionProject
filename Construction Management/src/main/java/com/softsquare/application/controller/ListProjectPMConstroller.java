...
@RestController
@RequestMapping("/listProjectPM.html")
@Configurable
public class ListProjectPMConstroller {
	...
	public void searchProjectPM(HttpServletRequest request, HttpServletResponse response, @ModelAttribute ProjectMapping mapping) throws Throwable{
		...
		String  json = gson.toJson(listprojectSevice.findProjectbyEmployee(mapping));
