...
orderHeader.buildGrid = function(){
	...
	orderHeader.fbutton = new Ext.ux.form.FileUploadField({
        buttonOnly: true
    });
	...
	orderHeader.columns = [orderHeader.sm, {
	       ...
	       align: 'center',
	       editor: orderHeader.fbutton
//	       renderer: function(value, metaData, record, rowIndex, colIndex, store){
//	    	   return '<img src="/hymanage/images/bbbb.png" height="72" width="72" />';
//	       }
	    },{
	       header: 'Period Date',
